...
//		g.fillText(b.getText(), b.getX() + b.getWidth() / 2, b.getY() + b.getHeight() / 2);
	...
	public void drawManual (GraphicsContext g) {
	    ...
	    g.drawImage(IL.ihammerbutton, b.getX() + 3, b.getY() + 3, b.getWidth() - 6, b.getHeight() - 6);
	    ...
	    g.drawImage(IL.izeitleiste, b.getX() + 3, b.getY() + 3, b.getWidth() - 6, b.getHeight() - 6); 
	    
	    b = Gui.manualbuttons[8]; 
	    g.drawImage(IL.ibabyhamster, b.getX() + 3, b.getY() + 3, b.getWidth() - 6, b.getHeight() - 6); 
	    
	    b = Gui.manualbuttons[9]; 
	    g.drawImage(IL.icompiler, b.getX() + 3, b.getY() + 3, b.getWidth() - 6, b.getHeight() - 6);
	    
	    b = Gui.manualbuttons[10]; 
	    g.drawImage(IL.iclipboard, b.getX() + 3, b.getY() + 3, b.getWidth() - 6, b.getHeight() - 6);
	    
	    b = Gui.manualbuttons[11]; 
	    g.drawImage(IL.iback, b.getX() + 3, b.getY() + 3, b.getWidth() - 6, b.getHeight() - 6);
	...
	public void drawAnleitung (GraphicsContext g) {
		...
		g.drawImage(IL.iplayer0, Gui.getWidth()- 605, Gui.getHeight()- 590, 30,30);
		g.drawImage(IL.ienemy0, Gui.getWidth()- 630, Gui.getHeight()- 550, 30, 30);
		g.drawImage(IL.ipicture, Gui.getWidth()-270,  Gui.getHeight()-525, 250, 250);
		g.drawImage(IL.iupKey, Gui.getWidth() -490 , Gui.getHeight()-340 , 40, 40);
		g.drawImage(IL.idownKey, Gui.getWidth() -630 , Gui.getHeight()-295 , 40, 40);
		g.drawImage(IL.ileftKey, Gui.getWidth() -630 , Gui.getHeight()-340 , 40, 40);
		g.drawImage(IL.irightKey, Gui.getWidth() -455 , Gui.getHeight()-385 , 40, 40);

	}
	public void drawErklärung(GraphicsContext g) {

		if(Player.getSchritte() < 6) {
